namespace LeetCodeDaily20260312;
public class DSU {
    public int[] parent;
...
public class Solution {
    // the Solution is based on the idea of binary search and DSU (Disjoint Set Union).
    // this is an UnSolved problem, and the solution is based on the idea of binary search and DSU (Disjoint Set Union).
